...
<div class="modal-dialog">
           <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Data Sales Order Barang <button type="button" class="close" aria-label="Close" onclick="$('#ModalBarangShow2').modal('hide');"><span>&times;</span></button></h4>                    
                    </div>
                ...
                <?php
                  ...
                  <div class="form-group">
                      ...
                      <div class="but">
                                    <button type="button" class="btn btn-primary" name="close" onclick="$('#ModalBarangShow2').modal('hide');">Close</button>
                     </div>
                     </div>
                     </div>
           </div>
