...
<div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalCash" style="text-align: center;padding-right: 0px">Tambah Data Cash <button type="button" class="close" aria-label="Close" onclick="$('#ModalCashAdd').modal('hide');"><span>&times;</span></button></h4>  
                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <button type="submit" class="btn btn-primary save_submit" name="Submit" value="SIMPAN">Simpan</button>
                                   <button type="button" class="btn btn-primary" onclick="$('#ModalCashAdd').modal('hide');">&nbsp;Batal&nbsp;</button>
                          </div>
                        </div>
                        </div>
