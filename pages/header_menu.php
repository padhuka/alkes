...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <div class="container">
      <a class="navbar-brand" href="index.php"> PT. NUSA ASIA MEDIKA
        </a>
        ...
        <ul class="nav navbar-nav" style="list-style: none;padding: 0;margin: 0 auto;font-size: 1px;margin-top: 8px;">
         ...
         <?php if ($seskdlvl=='Admin'){?>
           <li class="dropdown" style="display: block;margin:0;padding:0;float: left;">
            ...
            <ul class="dropdown-menu">
               <li class="header"><a href="?p=kwitansi">Faktur</a></li> 
               <li class="header"><a href="?p=rekapkwitansi">Rekap Faktur</a></li>  
