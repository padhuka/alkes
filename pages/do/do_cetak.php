...
<?php
   // include_once '../../lib/sess.php';
    ...
    $iddo= $_GET['iddo'];
    //   $sqlpan= "SELECT * FROM t_estimasi WHERE id_delivery_order='$iddo'";
 //  $catat= mysql_fetch_array(mysql_query($sqlpan));
  
   ?>
   <?php
                                   $j=1;
                                    $sqlcatat2 = "SELECT * FROM t_delivery_order e 
                                ...
                                ?>
                                <table width="100%">
                                  <tr><td align="center" style="font-size: 20px; text-align: center;"><u>DELIVERY ORDER DETAIL</u></td></tr>
                                  <tr><td align="center" style="font-size: 18px; text-align: center;"><?php echo $catat2['id_delivery_order'];?></td></tr>
                                </table>
                                <table class="">
                                   <td>
                                     <th class="col-sm-8">
                                    <tr> <th>No Sales Order</th> <td > : <?php echo $catat2['id_delivery_order'];?></td></tr>
