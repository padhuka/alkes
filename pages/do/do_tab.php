  ...
  <div class="content-wrapper">
    ...
    Data  Delivery Order (DO)
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Delivery Order (DO)</li>
      </ol>
    </section>
    ...
    <!-- /.content -->
        ...
        <div id="ModalShow" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         ...
         <div id="ModalDoDet" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         <div id="ModalDoPrint" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
