  ...
  <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Data Barang <button type="button" class="close" aria-label="Close" onclick="$('#ModalAddDoBarang').modal('hide');"><span>&times;</span></button></h4>  
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function (){
                 $("#tablebarang").load('do/barang_load.php?iddo=<?php echo $iddo;?>');
            });
        </script>
