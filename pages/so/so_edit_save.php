<?php
        ...
        $tgl_transaksi = trim($_POST['tgltransaksi']);
        ...
        //UPDATE t_penjualan\
        $updateEs = "UPDATE t_penjualan SET tgl_transaksi='$tgl_transaksi',fk_customer='$customer',fk_marketing='$marketing',keterangan='$keterangan' WHERE id_penjualan='$idso'";
