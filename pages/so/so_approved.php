            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Approve Data Sales Order <button type="button" class="close" aria-label="Close" onclick="$('#ModalApproved').modal('hide');"><span>&times;</span></button></h4> 
                    </div>
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                           $.ajax({
                                url: 'so/so_approved_save.php?idso=<?php echo $id;?>',
                                type: 'GET',
