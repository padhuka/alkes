<!-- general form elements disabled -->
   ...
   // include_once '../../lib/sess.php';
    ...
    $idpo= $_GET['idpo'];
 //   $sqlpan= "SELECT * FROM t_pembelian WHERE id_estimasi='$idpo'";
           ...
           <div class="modal-content">
                  ...
                  <?php
                    ...
                    <div class="modal-body">
                     ...
                     <div class="but">
                                    <button type="button" class="btn btn-primary" name="part" onclick="partshow('<?php echo $idpo;?>');">&nbsp;Part&nbsp;</button>
                                    <button type="button" class="btn btn-primary" name="panel" onclick="panelshow('<?php echo $idpo;?>');">Panel</button>
                     </div>
                     </div>
                     </div>
                       <div class="form-group">
...
<script type="text/javascript">
            ...
            function partshow(y){
              $.ajax({
                    url: "estimasi/part_show_tab.php?idpone="+y,
                    type: "GET",
              ...
              $.ajax({
                    url: "estimasi/panel_show_tab.php?idpone="+z,
                    type: "GET",
                      success: function (ajaxData){
