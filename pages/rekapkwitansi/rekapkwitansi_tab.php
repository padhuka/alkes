  ...
  <div class="content-wrapper">
    ...
    Data Rekap Kwitansi
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Rekap Kwitansi</li>
      </ol>
    </section>
    ...
    <!-- /.content -->
        ...
        <div id="ModalShow" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         ...
         <div id="ModalRKDetail" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         <div id="ModalrekapkwitansiPrint" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
